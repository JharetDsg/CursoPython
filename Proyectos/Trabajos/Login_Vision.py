...
#Se requiere instalar estas librerias
...
def registrar_usuario():
    usuario_info = usuario.get()  # Obetenemos informacion de usuario
    contra_info = contra.get()  # Obtenemos informacion de contraseña
